...
function nextStep(index) {
  ...
  indicators[index - 1].classList.add('done');
  
  bar.style.width = `${(index + 1) * 33.33}%`;
}
...
function prevStep(index) {
  ...
  indicators[index].classList.remove('done');
